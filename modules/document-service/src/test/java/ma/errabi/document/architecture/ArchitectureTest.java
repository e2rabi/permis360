package ma.errabi.document.architecture;
...
@AnalyzeClasses(packages = "ma.errabi.document")
public class ArchitectureTest {
    ...
    @ArchTest
    static final ArchRule services_must_be_annotated = classes()
            .that().resideInAPackage("..impl..")
            .should().beAnnotatedWith(Service.class)
            .because("All classes in the service package must be valid Spring Services.");
